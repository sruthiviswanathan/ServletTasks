...
public class QueryConstants {
	...
	public static final String VIEWAPPLIEDUSERS="select user_classification.user_name,company_id,job.job_designation,applyforjob.email,applyforjob.location from applyforjob,user_classification,job where company_id=? and user_classification.user_id=applyforjob.user_id and applyforjob.job_id = job.job_id";
