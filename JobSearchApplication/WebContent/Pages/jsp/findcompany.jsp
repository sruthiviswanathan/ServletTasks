...
<head>
        ...
        <link rel="stylesheet" href="${Config.BASE_PATH}Pages/css/companydetails.css">
                ...
                <div class="navbar">
                        <ul>
                                ...
                                <a href="${Config.BASE_PATH}RegisterAdminServlet">
                                        <li style="float:right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>SIGN IN</li>
                                </a>
                ...
                <div class="row">
                        <form action="${Config.BASE_PATH}FindCompanyServlet" method="post">
                                ...
                                <div class="col-60 col-xs-12 col-sm-12">
                                        <input type="text" name="companyName" placeholder="Search for Company.."
